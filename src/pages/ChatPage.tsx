  ...
  return (
    <div className="min-h-screen bg-[#303030]">
      ...
      <div className="ml-64 h-screen flex flex-col">
        <div className="bg-[#1a1a1d] border-b p-4">
          <h1 className="text-xl font-semibold text-[#e5e7eb]">Community Chat</h1>
          <p className="text-sm text-[#e5e7eb]">Connect with other community members</p>
        </div>
        ...
        <form onSubmit={handleSendMessage} className="p-4 bg-[#1a1a1d] border-t">
