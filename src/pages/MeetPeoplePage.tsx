    ...
    <div className="min-h-screen bg-[#171717]">
      ...
      <div className="ml-64 p-8">
        <div className="max-w-xl mx-auto">
          <h1 className="text-3xl font-bold text-[#e5e7eb] mb-8">Meet New People</h1>

          {currentProfile ? (
            <div
              className={`bg-[#1a1a1d] rounded-lg shadow-lg overflow-hidden transform transition-transform duration-300 ${
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-4">
                  <div>
                    ...
                    <p className="text-[#e5e7eb]">Score: {currentProfile.score}</p>
                  </div>
                </div>

                <p className="text-[#e5e7eb] mb-4">{currentProfile.bio}</p>
                ...
                <div className="flex justify-center space-x-4">
                  <button
                    ...
                    className="p-4 bg-red-100 rounded-full text-red-600 hover:bg-red-900 transition-colors"
                  >
                    <X className="h-8 w-8" />
                  </button>
                  <button
                    onClick={() => handleSwipe('right')}
                    className="p-4 bg-green-100 rounded-full text-green-600 hover:bg-green-900 transition-colors"
                  >
